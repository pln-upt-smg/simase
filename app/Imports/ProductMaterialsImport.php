...
class ProductMaterialsImport implements ToModel, SkipsEmptyRows, WithHeadingRow, WithValidation, WithMultipleSheets, WithBatchInserts, WithChunkReading
{
    use HasValidationException, HasDefaultSheet, HasProductResolver, HasMaterialResolver, HasRowCounter, HasAreaResolver, HasBatchSize, HasChunkSize;
