            ...
            <div>
                ...
                >
                    <component
                        ...
                        :href="previousPageUrl"
                        :class="{
                            'hover:bg-gray-100': previousPageUrl,
                            'cursor-not-allowed bg-gray-100': !previousPageUrl,
                        }"
                    ...
                    <component
                        ...
                        :href="nextPageUrl"
                        :class="{
                            'hover:bg-gray-100': nextPageUrl,
                            'cursor-not-allowed bg-gray-100': !nextPageUrl,
                        }"
