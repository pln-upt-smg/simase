                                ...
                                <div class="py-6 px-4 bg-indigo-700 sm:px-6">
                                    ...
                                    <div class="mt-1">
                                        <p class="text-sm text-indigo-300">
                                            Mohon arahkan kamera ke barcode target dengan pencahayaan ruangan yang
                                            cukup.
                                        </p>
                                    </div>
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="ml-3">
                                                    <h3 class="text-sm font-medium text-blue-800">
                                                        Mohon perhatikan hal berikut untuk mendapatkan performa
                                                        pemindaian yang maksimal.
                                                    </h3>
