<template>
    <app-layout title="Kecamatan">
        ...
        >
            ...
            <template #body>
                <tr
                    v-for="sub_district in sub_districts.data"
                    :key="sub_district.id"
                >
                    ...
                    <td v-show="showColumn('action')" class="text-center">
                        <jet-dropdown name="Opsi">
                            ...
                            <menu-item>
                                <button
                                    @click="confirmDestroy(sub_district)"
                                    class="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 group"
                                >
                                    <trash-icon
                                        class="w-5 h-5 mr-3 text-gray-700"
        ...
        >
            <template #content>
                Silakan masukkan data kecamatan yang ingin ditambahkan.
        ...
        >
            <template #content>
                Silakan masukkan data kecamatan yang ingin diubah.
                <jet-validation-errors class="mt-4" />
                <div class="mt-4">
                    <jet-input
                        type="text"
        ...
        >
            <template #content>
                Apakah Anda yakin ingin menghapus kecamatan ini? Setelah
                kecamatan dihapus, semua sumber daya dan datanya akan dihapus
        ...
        <jet-import-modal
            ...
            title="Impor data kecamatan"
        >
            <template #content>
                <p>
                    Silakan unggah file data kecamatan yang ingin di-impor.
        ...
        <jet-export-modal
            ...
            title="Ekspor data kecamatan"
        >
            <template #content>
                <p>
                    Apakah Anda yakin ingin mengekspor semua data kecamatan?
...
export default defineComponent({
    ...
    methods: {
            ...
            this.storeForm.post(route("sub-districts.store"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        ...
                        "Sistem telah berhasil menyimpan data kecamatan baru"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat menyimpan data kecamatan, mohon periksa ulang form"
                    ),
            });
        },
        update() {
            this.updateForm.put(
                route("sub-districts.update", this.updateForm.id),
                {
                    ...
                    onSuccess: () => {
                        ...
                        this.showSuccessNotification(
                            "Kecamatan berhasil diedit",
                            "Sistem telah berhasil mengedit data kecamatan"
                        );
                    },
                    onError: () =>
                        this.showDangerNotification(
                            "Kesalahan telah terjadi",
                            "Sistem tidak dapat mengubah data kecamatan, mohon periksa ulang form"
                        ),
                }
            );
        },
                ...
                route("sub-districts.destroy", this.destroyForm.id),
                {
                    ...
                    onSuccess: () => {
                        ...
                        this.showSuccessNotification(
                            ...
                            "Sistem telah berhasil menghapus data kecamatan"
                        );
                    },
                    onError: () =>
                        this.showDangerNotification(
                            "Kesalahan telah terjadi",
                            "Sistem tidak dapat menghapus data kecamatan"
                        ),
                }
            );
        },
            ...
            this.importForm.post(route("sub-districts.import"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        ...
                        "Sistem berhasil menjadwalkan permintaan impor data kecamatan di latar belakang"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat mengimpor data kecamatan, mohon periksa kesalahan yang telah dideteksi"
                    ),
            });
        },
        exportFile() {
        ...
        confirmUpdate(sub_district) {
            this.updateForm.id = sub_district.id;
            this.updateForm.name = sub_district.name;
            setTimeout(() => (this.confirmingUpdate = true), 150);
            setTimeout(() => this.$refs.updateFuncloc.focus(), 300);
        },
        confirmDestroy(sub_district) {
            this.destroyForm.id = sub_district.id;
        ...
        reloadData() {
            this.$refs.table.reload("sub_districts");
        },
    },
});
</script>
