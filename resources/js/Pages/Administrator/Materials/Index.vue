<template>
    <app-layout title="Material Master">
            ...
            <template #content>
                ...
                <div class="mt-4">
                    <jet-select
                        ...
                        v-model="storeForm.period"
                        :data="periods"
                        class="block w-full"
                    />
                    <jet-input
                        type="text"
                        class="mt-4 block w-full uppercase"
                    ...
                    <jet-input
                        type="text"
                        class="mt-4 block w-full capitalize"
        ...
        <jet-alert-modal
            ...
            title="Hapus material master"
        >
            <template #content>
                Apakah Anda yakin ingin menghapus material master ini? Setelah
                material master dihapus, semua sumber daya dan datanya akan
        ...
        <jet-import-modal
            ...
            title="Impor data material master"
        >
            <template #content>
                <p>
                    Silakan unggah file data material master yang ingin
                    di-impor. Pastikan Anda sudah menggunakan template
                    spreadsheet yang ditentukan. Sistem hanya memproses data
                    yang ada pada sheet <b>Worksheet</b>.
                </p>
                <p class="mt-2">
                    ...
                    >
                        <div class="space-y-1 text-center">
                            ...
                            >
                                <label
                                    for="import-file"
                                    class="relative bg-white rounded-md font-medium text-amber-600 hover:text-amber-500 cursor-pointer"
                                >
                                    <span>
                                        {{
        ...
        <jet-export-modal
            ...
            title="Ekspor data material master"
        >
            <template #content>
                <p>
                    Apakah Anda yakin ingin mengekspor semua data material
                    master? Proses ekspor dapat memakan waktu lama, tergantung
                ...
                <p class="mt-2">
                    Anda dapat menyaring data material master berdasarkan
                    periodenya dengan menyesuaikan kolom pilihan dibawah ini.
                </p>
                <div class="mt-4">
                    <jet-select
                        ref="exportPeriod"
            ...
            this.storeForm.post(route("materials.store"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        "Material master berhasil ditambahkan",
                        "Sistem telah berhasil menyimpan data material master baru"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat menyimpan data material master, mohon periksa ulang form"
                    ),
            });
        },
        update() {
            this.updateForm.put(route("materials.update", this.updateForm.id), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        "Material master berhasil diedit",
                        "Sistem telah berhasil mengedit data material master"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat mengubah data material master, mohon periksa ulang form"
                    ),
            });
        },
        destroy() {
            this.destroyForm.delete(
                route("materials.destroy", this.destroyForm.id),
                {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.reloadData();
                        ...
                        this.showSuccessNotification(
                            "Material master berhasil dihapus",
                            "Sistem telah berhasil menghapus data material master"
                        );
                    },
                    onError: () =>
                        this.showDangerNotification(
                            "Kesalahan telah terjadi",
                            "Sistem tidak dapat menghapus data material master"
                        ),
                }
            );
        },
            ...
            this.importForm.post(route("materials.import"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        ...
                        "Sistem berhasil menjadwalkan permintaan impor data material di latar belakang"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat mengimpor data material, mohon periksa kesalahan yang telah dideteksi"
                    ),
            });
        },
        exportFile() {
            window.open(
                route("materials.export", {
