<template>
    <app-layout title="Kelurahan">
                ...
                >
                    ...
                    <td v-show="showColumn('action')" class="text-center">
                        <jet-dropdown name="Opsi">
                            ...
                            <menu-item>
                                <button
                                    @click="confirmDestroy(urban_village)"
                                    class="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 group"
                                >
                                    <trash-icon
                                        class="w-5 h-5 mr-3 text-gray-700"
        ...
        >
            <template #content>
                Silakan masukkan data kelurahan yang ingin ditambahkan.
        ...
        >
            <template #content>
                Silakan masukkan data kelurahan yang ingin diubah.
                <jet-validation-errors class="mt-4" />
                <div class="mt-4">
                    <jet-input
                        type="text"
        ...
        >
            <template #content>
                Apakah Anda yakin ingin menghapus kelurahan ini? Setelah
                kelurahan dihapus, semua sumber daya dan datanya akan dihapus
        ...
        <jet-import-modal
            ...
            title="Impor data kelurahan"
        >
            <template #content>
                <p>
                    Silakan unggah file data kelurahan yang ingin di-impor.
        ...
        <jet-export-modal
            ...
            title="Ekspor data kelurahan"
        >
            <template #content>
                <p>
                    Apakah Anda yakin ingin mengekspor semua data kelurahan?
...
export default defineComponent({
    ...
    methods: {
            ...
            this.storeForm.post(route("urban-villages.store"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        ...
                        "Sistem telah berhasil menyimpan data kelurahan baru"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat menyimpan data kelurahan, mohon periksa ulang form"
                    ),
            });
        },
        update() {
            this.updateForm.put(
                route("urban-villages.update", this.updateForm.id),
                {
                    ...
                    onSuccess: () => {
                        ...
                        this.showSuccessNotification(
                            "Kelurahan berhasil diedit",
                            "Sistem telah berhasil mengedit data kelurahan"
                        );
                    },
                    onError: () =>
                        this.showDangerNotification(
                            "Kesalahan telah terjadi",
                            "Sistem tidak dapat mengubah data kelurahan, mohon periksa ulang form"
                        ),
                }
            );
        },
                ...
                route("urban-villages.destroy", this.destroyForm.id),
                {
                    ...
                    onSuccess: () => {
                        ...
                        this.showSuccessNotification(
                            ...
                            "Sistem telah berhasil menghapus data kelurahan"
                        );
                    },
                    onError: () =>
                        this.showDangerNotification(
                            "Kesalahan telah terjadi",
                            "Sistem tidak dapat menghapus data kelurahan"
                        ),
                }
            );
        },
            ...
            this.importForm.post(route("urban-villages.import"), {
                ...
                onSuccess: () => {
                    ...
                    this.showSuccessNotification(
                        ...
                        "Sistem berhasil menjadwalkan permintaan impor data kelurahan di latar belakang"
                    );
                },
                onError: () =>
                    this.showDangerNotification(
                        "Kesalahan telah terjadi",
                        "Sistem tidak dapat mengimpor data kelurahan, mohon periksa kesalahan yang telah dideteksi"
                    ),
            });
        },
        exportFile() {
        ...
        confirmUpdate(urban_village) {
            this.updateForm.id = urban_village.id;
            this.updateForm.name = urban_village.name;
            setTimeout(() => (this.confirmingUpdate = true), 150);
            setTimeout(() => this.$refs.updateFuncloc.focus(), 300);
        },
        confirmDestroy(urban_village) {
            this.destroyForm.id = urban_village.id;
        ...
        reloadData() {
            this.$refs.table.reload("urban_villages");
        },
    },
});
</script>
