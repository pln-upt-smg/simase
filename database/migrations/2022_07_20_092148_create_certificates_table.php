...
class CreateCertificatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('certificates', function (Blueprint $table) {
            ...
            $table->timestamp('certificate_bookkeeping_date');
            $table->timestamp('certificate_publishing_date');
            $table->timestamp('certificate_final_date');
            $table->string('nib');
            ...
            $table->timestamp('measuring_letter_date');
